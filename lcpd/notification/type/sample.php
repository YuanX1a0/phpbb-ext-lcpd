...
class sample extends \phpbb\notification\type\base
{
	...
	{
		return 'siwode.lcpd.notification.type.sample';
	}
	...
	{
		return $this->language->lang('SIWODE_LCPD_NOTIFICATION');
	}
	...
	{
		return $this->helper->route('siwode_lcpd_controller', $this->get_data('lcpd_sample_name'));
	}
	...
	{
		$this->set_data('lcpd_sample_name', $data['lcpd_sample_name']);
