...
class install_sample_data extends \phpbb\db\migration\migration
{
	...
	{
		return $this->config->offsetExists('siwode_lcpd_sample_int');
	}
	...
	public function update_data()
	{
		return [
			...
			['config.add', ['siwode_lcpd_sample_int', 0]],
			['config.add', ['siwode_lcpd_sample_str', '']],

			// Add a new config_text table setting
			['config_text.add', ['siwode_lcpd_sample', '']],

			// Add new permissions
			['permission.add', ['a_new_siwode_lcpd']], // New admin permission
			['permission.add', ['m_new_siwode_lcpd']], // New moderator permission
			['permission.add', ['u_new_siwode_lcpd']], // New user permission
			...
			['permission.permission_set', ['ROLE_ADMIN_FULL', 'a_new_siwode_lcpd']], // Give ROLE_ADMIN_FULL a_new_siwode_lcpd permission
			['permission.permission_set', ['ROLE_MOD_FULL', 'm_new_siwode_lcpd']], // Give ROLE_MOD_FULL m_new_siwode_lcpd permission
			['permission.permission_set', ['ROLE_USER_FULL', 'u_new_siwode_lcpd']], // Give ROLE_USER_FULL u_new_siwode_lcpd permission
			['permission.permission_set', ['ROLE_USER_STANDARD', 'u_new_siwode_lcpd']], // Give ROLE_USER_STANDARD u_new_siwode_lcpd permission
			['permission.permission_set', ['REGISTERED', 'u_new_siwode_lcpd', 'group']], // Give REGISTERED group u_new_siwode_lcpd permission
			['permission.permission_set', ['REGISTERED_COPPA', 'u_new_siwode_lcpd', 'group', false]], // Set u_new_siwode_lcpd to never for REGISTERED_COPPA

			// Add new permission roles
			['permission.role_add', ['lcpd admin role', 'a_', 'a new role for admins']], // New role "lcpd admin role"
			['permission.role_add', ['lcpd moderator role', 'm_', 'a new role for moderators']], // New role "lcpd moderator role"
			['permission.role_add', ['lcpd user role', 'u_', 'a new role for users']], // New role "lcpd user role"
